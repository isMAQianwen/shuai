...
# Model
# from model.model_DNANet_improve3 import  Res_CBAM_block
# from model.model_DNANet_improve3 import  DNANet
...
def parse_args():
    ...
    parser.add_argument('--img_demo_index_reverse', type=str,default='000720',
                        help='target1, target2, target3')
...
class Trainer(object):
    def __init__(self, args):
        ...
        checkpoint      = torch.load(r'.\NUDT-DNA-weights\AB-NUDT-DNA-twoflowadd.tar',map_location=device)
        ...
        if args.deep_supervision == 'True':
            ...
            # 保存为Jet格式的图像
            cv2.imwrite('pred_jet2.png', pred_np_jet)
