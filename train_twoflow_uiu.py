...
# model
from model.model_DNANet_maxloss import  Res_CBAM_block
from model.model_DNANet_maxloss import  DNANet
    ...
    def training(self,epoch):
        ...
        for i, ( data, datareverse, labels) in enumerate(tbar):
            ...
            if args.deep_supervision == 'True':
                ...
                loss /= 7   #len(preds)
                # if i == 80:
                #     print("This is net1_pred", preds[4])
                #     print("This is net2_pred", preds[5])
            else:
